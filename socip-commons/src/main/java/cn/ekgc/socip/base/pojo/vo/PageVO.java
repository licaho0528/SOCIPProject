...
public class PageVO<E> implements Serializable {
	...
	static {
		try {
			...
			properties.load(PageVO.class.getClassLoader().getResourceAsStream("props/base/base.properties"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public PageVO(Integer pageNum, Integer pageSize) {
		if (pageNum != null && pageNum > 0) {
			...
			this.pageNum = Integer.parseInt(properties.getProperty("base.page.num"));
		}
		if (pageSize != null && pageSize > 0) {
			this.pageSize = pageSize;
		} else {
			this.pageSize = Integer.parseInt(properties.getProperty("base.page.size"));
		}
	}
